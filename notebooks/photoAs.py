...
# %% [markdown]
# # Photoarsenotrophy — As(III) as the electron donor
#
# *Ectothiorhodospira* sp. PHS-1, from the hot springs of Paoha Island in
# Mono Lake, fixes CO₂ using arsenite as its electron donor and light as its
# energy source. It was the first arsenic-based phototroph described.
#
...
# ## The reaction
#
# As(III) → As(V) is a two-electron step sitting at +0.013 V at pH 7,
# far too weak to reduce CO₂ on its own.
...
# %% [markdown]
# Arsenite is the cheapest of the three donors after iron: about 0.73
# photons' worth at pH 7, so a single 870 nm photon per electron pair
